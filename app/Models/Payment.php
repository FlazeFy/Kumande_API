 ...
 *     schema="Payment",
 *     type="object",
 *     required={"id", "consume_id", "payment_method", "is_payment", "created_at", "created_by"},
 * 
 ...
 *     @OA\Property(property="is_payment", type="boolean", description="Indicates if the consume is come with payment"),
 * 
 ...
 *     @OA\Property(property="updated_by", type="string", format="uuid",description="ID of the user who updated the payment")
 * )
 */
